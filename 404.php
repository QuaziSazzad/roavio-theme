...
$error_title    = Helper::get_option('error_title', esc_html__('"Oops! It looks like something went wrong."', 'roavio'));
$error_message  = Helper::get_option('error_bottom_message', esc_html__('The page you are looking for does not exist or has been moved', 'roavio'));
