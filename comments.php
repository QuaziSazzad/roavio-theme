...
<div id="comments" class="comments-area">
	...
	$roavio_comment_fields = array(
		'author' => ' <div class="col-sm-6"><div class="form-group"><input type="text" id="name" name="author" class="form-control" placeholder="' . esc_attr__('Your Name', 'roavio') . '" value="' . esc_attr($roavio_commenter['comment_author']) . '" required></div></div>',
		'email' => ' <div class="col-sm-6"><div class="form-group"><input type="text" id="email" name="email" class="form-control" placeholder="' . esc_attr__('Your Email', 'roavio') . '" value="' . esc_attr($roavio_commenter['comment_author_email']) . '" required ></div></div>',
	);
	$roavio_comments_args = array(
		...
		'comment_field' => ' <div class="col-sm-12"><div class="form-group"><textarea name="comment" id="comment" class="form-control" rows="4" placeholder="' . esc_attr__('Write Comment', 'roavio') . '" required></textarea></div></div>',
		'comment_notes_after' => '',
